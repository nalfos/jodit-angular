...
@Component({
  ...
  styleUrls: ["../../../../node_modules/jodit/build/jodit.es2018.min.css"],
  ...
  implements AfterViewInit, OnDestroy, ControlValueAccessor
{
  ...
  createElement() {
    const tagName =
      typeof this.tagName === "string" ? this.tagName : "textarea";
  ...
  createEditor() {
    ...
    validEvents.forEach((eventName) => {
      ...
      if (eventEmitter.observers.length > 0) {
        ...
        eventNameInJodit =
          eventNameInJodit.substr(0, 1).toLowerCase() +
          eventNameInJodit.substring(1);
